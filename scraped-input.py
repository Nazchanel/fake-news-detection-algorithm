...
# Train score
print(f"\nTrain Score: {text_clf.score(X_train, y_train)}\n")

# Test score
print(f"Test Score: {text_clf.score(X_test, y_test)}\n")
...
df2 = pd.DataFrame(text_sample, columns=['text'])
...
# Append the sub-url that the user chooses to the parent url
...
# NOTE: Columns is predicted and index are actual value
